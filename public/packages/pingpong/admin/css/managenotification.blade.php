  ...
  <div class="col-sm-12 pad seaction1-driver">
    ...
    <div class="col-sm-9 pad">
      <div class="col-sm-6 pad new-manage">
        <p><span>User Type:</span>Passanger <a href="">View Passanger Proffile</a> </p>
      ...
      <div class="col-sm-6 pad">
        ...
        <div class="col-sm-5 dateofjoining suspend-button">
          ...
          <div class="address-line">
            ...
            <p><span>DeziBonus:</span>$10<span class="glyphicon glyphicon-edit"></span></p>
          </div>
        </div>
      </div>
      <div class="col-sm-2 pad manage-span">
        <p><span>25:</span>Rides Given</p>
      </div>
      <div class="col-sm-2 pad manage-span">
        <p><span>2:</span>Issues Raised</p>
      </div>
      <div class="col-sm-2 pad manage-span">
        <p><span>1522222:</span>Last Ride</p>
      </div>
      <div class="col-sm-2 pad manage-span">
        <p><span>$22:</span>Bill Cleared</p>
      </div>
      <div class="col-sm-2 pad manage-span">
        <p><span>$22:</span>Earnings</p>
      </div>
      <div class="col-sm-2 pad manage-span"> </div>
    </div>
  </div>
  <hr>
  </hr>
  <div class="next-seaction">
    ...
    <div class="sub-seaction1">
      ...
      <div class="pull-right seaction-right">
        <p><span>Time-stamp:</span>1:38pm</p>
        <p><span>Admin:</span>Pallav</p>
      </div>
    </div>
    <div class="sub-seaction1">
      <div class="pull-left seaction-left">
    ...
    <textarea rows="4" col="50"class="text-lorem">
At w3schools.com you will learn how to make a website. We offer free tutorials in all web development technologies.
</textarea>
    <div class="pull-right manage-last">
      <button type="submit" class="btn btn-default manage-can">Cancel</button>
