...
<script>
  ...
  var indexUrl2= "{!! route('passengerAjax') !!}";
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box"> <span class="info-box-icon bg-green"><i class="fa fa-location-arrow" aria-hidden="true"></i></span>
            <div class="info-box-content"> <span class="info-box-text"><?php echo ucfirst(@$citiesCount['most']->city);?></span> <span class="info-box-number">{{ @$citiesCount['most']->no_of_users . ' - ' .@$citiesCount['most']->state_code }}</span> <span class="totl_pass">Most Passenger City</span> </div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-location-arrow" aria-hidden="true"></i></span>
            <div class="info-box-content"> <span class="info-box-text"><?php echo ucfirst(@$citiesCount['least']->city);?> </span> <span class="info-box-number">{{ @$citiesCount['least']->no_of_users . ' - ' . @$citiesCount['least']->state_code}}</span> <span class="totl_pass">Least Passenger City</span> </div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
