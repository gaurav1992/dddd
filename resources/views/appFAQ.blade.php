...
@section('content')
<div class="container-fluid no-padding" id="inner-header" style="margin-top:0px !important;"> <img src="{!! asset('public/images/form-head.jpg') !!}" alt="test" class="img-responsive">
