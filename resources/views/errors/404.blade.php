...
<head>
    ...
    <title>DeziNow | Page Not Found | 404</title>
    <style type="text/css">
    * { padding:0; margin:0; }
    body, html {
        width: 100%;
...
<body>
    <div id="text">
        ...
        <p>Uh oh, DeziNow couldn't find a link for the  URL you clicked.</p>
        <p>Most DeziNow Links are 4-6 characters, and only include letters and numbers (and are case sensitive).</p>
    </div>
    <div id="ripple-control"></div>
    <img id="fish" src="https://bitly.com/static/graphics/fish-404.png" />
    <div id="ripple"></div>

    <div id="cloud1"></div>
    <div id="cloud2"></div>
    <img id="gull" src="https://bitly.com/static/graphics/gull-404.png"/>

    <ul class="bottomLinkList">
        
        <li><a href="http://www.dezinow.com">Home</a></li>
        <li><a href="http://www.dezinow.com/contact">Contact Us</a></li>
        <li class="copy">&copy; 2016 DeziNow <span class="tm">TM</span></li>
    </ul>
