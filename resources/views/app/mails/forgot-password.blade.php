...
<table style="border-collapse: collapse; border-spacing: 0; border: 1px solid #A6CE45; background-color: #fff; padding: 0;" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr style="height: 36px;" height="36">
        ...
        <td style="width: 500px; background-color: #a6ce45;" width="500" valign="middle"><span style="background-color: #a6ce45;"><span style="color: white; font-size: small;"><strong>DeziNow- {{ $subject }}<br /></strong></span></span></td>
        <td style="width: 30px; background-color: #a6ce45;" width="30" valign="middle"><span style="background-color: #a6ce45;">&nbsp;</span></td>
    </tr>
    <tr>
...
<table style="border-collapse: collapse; border-spacing: 0; padding: 0;" border="0" cellspacing="0" cellpadding="0" width="499" height="108" align="left">
    <tbody>
    <tr>
        <td valign="top"><img style="height: 60px;display:block;margin-left:auto;margin-right:auto;text-align: center;width: 115px;" src="http://dezinowdev.mobilytedev.com/public/images/logo.png" alt="" /><br /></td>
    </tr>
    <tr>
        <td valign="top"><br /></td>
    </tr>
    ...
    <tr>
        <td valign="top">
            <p>Your Forgot Password Code is: {{ $token }}</p>
        </td>
    </tr>
	 <tr>
        <td valign="top">
            <p>Please visit the site to use this code to confirm your email address and to change your password.</p>
			<p>Please Driver Safely.</p>
        </td>
    </tr>
    <tr>
