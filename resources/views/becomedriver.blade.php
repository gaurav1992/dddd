...
<p class="driverRequest" style="display:none;"><?php echo $become_driver_request; ?></p>
    <?php if($become_driver_request == '1' && $is_driver_approved =='0'){ ?>
          <div class="confmsg">
            <p class="alert {{ Session::get('alert-class', 'alert-info') }}">
              ...
              <a class="confirmit" href="{!! asset('/editpassenger') !!}">OK</a>
            </p>
          </div>  
    ...
    @endif
   <!--  <div class="right-sec">
        <a href="{!! asset('passenger/profile') !!}"><button class="btn-grn edit pull-left back"><i class="fa fa-angle-left" aria-hidden="true"></i></button></a><span>New Appliction Form</span>
    </div> -->
<?php if($is_driver_approved !='1' && $become_driver_request !='1'){ ?>
    {!! Form::open(array('url' => 'becomedriver','class' => 'form becomedriver','files' => true,'id'=>'BecomeDriver')) !!}
    <div class="col-sm-12">
    ...
    <div class="col-sm-12">
        ...
        <label for="first_name">First Name:</label>
          <fieldset class="form-group">
            {!! Form::text('first_name',$first_name,array('id'=>'','class'=>'form-control','placeholder' => 'First Name','readonly' => 'readonly')) !!}
          </fieldset>
        </div>
        <div class="col-md-6">
        <label for="last_name">Last Name:</label>
          <fieldset class="form-group">
            {!! Form::text('last_name',$last_name,array('id'=>'','class'=>'form-control','placeholder' => 'Last Name','readonly' => 'readonly')) !!}
          </fieldset>
        </div>
        ...
        <label for="email">Email:</label>
          <fieldset class="form-group">
            {!! Form::email('email',$email,array('id'=>'','class'=>'form-control','placeholder' => 'Email','readonly' => 'readonly')) !!}
          </fieldset>
        </div>
          ...
          <label for="SSN/TIN">SSN/TIN #</label>
            <fieldset class="form-group"  style="position: relative;">
              @if($ssn)
              {!! Form::text('SSN',$ssn,array('id'=>'','class'=>'form-control ssnmasktop','placeholder' => 'SSN/TIN #')) !!}
              @else
              {!! Form::password('SSN',array('id'=>'ssnmask','class'=>'form-control ssnmasktop','placeholder' => 'SSN/TIN #')) !!}
              @endif
            </fieldset>
          </div>
          ...
          <label for="contact_number">Contact Number:</label>
            <fieldset class="form-group">
              {!! Form::text('contact_number',$contact_number,array('id'=>'','class'=>'form-control','placeholder' => 'Contact Number','readonly' => 'readonly')) !!}
            </fieldset>
          </div>
              <div class="col-md-6">
          ...
          <?php if($newDob ==''){ ?>
             <fieldset class="form-group">
                <div class='input-group date boder date-picker-three datePicker' id='datetimepicker1'>
                    {!! Form::text('dob',$newDob,array('id'=>'dob','class'=>'form-control','placeholder' => 'DD/MM/YYYY', 'required' => 'true')) !!}
          ...
          <?php } else{ ?>
              <fieldset class="form-group">
                <div class='input-group date boder date-picker-three'>
                    {!! Form::text('dob',$newDob,array('id'=>'dob','class'=>'form-control','placeholder' => 'DD/MM/YYYY', 'disabled'=>'disabled','required' => 'true')) !!}
        ...
        <label for="anniversary">Date of Anniversary:</label>
           <fieldset class="form-group">
              <div class='input-group date boder date-picker-two' id='datetimepicker4'>
                  {!! Form::text('anniversary',$newanniversary,array('id'=>'anniversary','class'=>'form-control','placeholder' => 'MM/DD/YYYY','required')) !!}
                  <a class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                  </a>
              </div>
      ...
      <?php }elseif($answer ==''){ ?>
              <div class="col-md-12 clearfix driver_question_answertext">
                ...
                <div class="input-group">
                  {!! Form::textarea('driver_records_9',$answer,array('id'=>'','rows' => '5', 'cols' => '100', 'class'=>'form-control','placeholder' => 'Describe here..')) !!}
              </div>
        <?php } $count++;$quest++; }  ?>
        <div class="col-md-12">
      ...
      <div class="submit-btn">
        ...
        <?php if($become_driver_request !='1'){ ?>
            {!! Form::submit('Submit', array('class'=>'btn btn-primary green-btn-s becomedriveredit')) !!}
        <?php }else{ ?>

        <?php } ?>
        <a href="{!! asset('/passenger/profile') !!}" class="btn btn-primary green-btn-s">Cancel</a>
      </div>
  </div>
  {!! Form::close() !!}
 <?php } ?> 
...
if('{{$user_detail->state}}'!=''){
		var stateCode= '{{$user_detail->state}}';
		$("#stateIds option[value='"+stateCode+"']").attr('selected', 'selected');
		cityCode(stateCode);
		var cityId='{{$user_detail->city}}';
		console.log(cityId);
