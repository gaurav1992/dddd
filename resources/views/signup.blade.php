                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                          <?php if(Auth::check()) { ?>
                            <p class="alert {{ Session::get('alert-class', 'alert-info') }}">You are already login!!</p><br/>
                          <?php }else{ ?>
                            @if(Session::has('message'))
                                <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('message') }}</p>
                            @endif
                            <br/>
                          <a href="{!! asset('/login') !!}" class="fb-link">Already have an account? Login here </a>
                            <div class="panel-body">
                                {!! Form::open(array('url' => 'signup','class' => 'form','id'=>'SignUpForm')) !!}
                                ...
                                <fieldset>
                                 ...
                                 <div class="form-group"> <a class="signup_margin" href="{!! asset('public/customer-terms-service-agreement.pdf') !!}" target="blank">By signing up, I agree to the Terms and Conditions</a></div>
                                  <div class="form-group">
                                    <div class="loactionadata" style="display:none;">
                                    </div> 
                                    {!! Form::submit('Confirm', array('class'=>'btn btn-lg btn-primary btn-block GRN')) !!}
                                  </div>
                                </fieldset>
                              {!! Form::close() !!}    
                            <?php } ?>
