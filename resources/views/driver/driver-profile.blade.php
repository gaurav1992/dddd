			...
			<div class="col-md-8">
				<div class="edit-btnn">
					<?php if($is_driver_approved == '1'){ ?>
						<a href="{!! asset('/editdriver') !!}" class="btn-grn edit pull-right">EDIT PROFILE</a>
					<?php } ?>
				...
				<div class="right-sec">
					<div class="col-sm-12">
						<?php if($driver_profile_pic !=''){ ?>
							<img src="{!! asset($driver_profile_pic) !!}" class="img-responsive center-block thumbnail profilePic" alt="#"/>
						<?php }else{ ?>
